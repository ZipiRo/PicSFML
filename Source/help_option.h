void HelpOption()
{
    ...
    std::cout << "Usage:\n";
    std::cout << "picsfml [option] <path> [argumets] (value) ...\n";
    std::cout << '\n';
    ...
    std::cout << "  Arguments:\n";
    std::cout << "      -n,  --name                 Project name <string> (default PicSFMLProject)\n";
    std::cout << "      -o,  --output               Output name <string> (default main)\n";
    std::cout << "      -m,  --main                 Main file name <string> (default main.cpp)\n";
    std::cout << "      -g,  --gcc                  GCC path <string> (path to mingw(32|64) directory)\n";
    std::cout << "      -s,  --sfml                 SFML path <string> (path to SFML-x.x.x directory)\n";
    std::cout << "      -sv, --sfml_version         SFML version <string> (default 3.0.0) {versions suported: 2.6.2, 3.0.0}\n";
